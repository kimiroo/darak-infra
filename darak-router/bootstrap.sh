...
# Interface
echo '[3/9] Configuring "Interface"...'
...
echo '  - [1/2] Deleting "Container" config...'
delete container
echo '  - [2/2] Configuring "HAProxy"...'
source "$SCRIPT_DIR/modules/container/haproxy.sh"
